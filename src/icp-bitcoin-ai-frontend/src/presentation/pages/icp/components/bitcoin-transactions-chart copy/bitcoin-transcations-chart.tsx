...
import styles from './bitcoin-transactions-chart-styles.module.scss'
...
export const BitcoinTransactionsChart: React.FC<Props> = ({ title, data, legend, key, range }: Props) => {
