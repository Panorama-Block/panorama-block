...
import styles from './canisters-chart-styles.module.scss'
...
export const CanistersChart: React.FC<Props> = ({ title, data, legend, key, range }: Props) => {
